      ...
      public void MEnviaFacturas()
      {
          ...
          foreach (DataGridViewRow fila in dgvFacturas.Rows)
          {
              ...
              if (Convert.ToBoolean(fila.Cells["Select"].Value))
              {
                  ...
                  _rutaXML = @"\\" + conexion.RutaReportes + @"\b1_shr\xml\xml\TPD051215UZ1\" + EDocNum;
          ...
          LinkedResource logo = new LinkedResource("\\\\" + conexion.RutaReportes + @"\\b1_shr\\xml\\TPD\\Facturas\\Facturas\\Facturas\\tpd.png");
