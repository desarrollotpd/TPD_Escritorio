 ...
 public partial class Ventas_Linea_Remate_Obsoletos : Form
 {
  ...
  public void diseñoGridDetalles()
  {
   ...
   try {
    ...
    dgvDetalles.Columns[1].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleLeft;
    dgvDetalles.Columns[1].ReadOnly = true;
    dgvDetalles.Columns[1].Width = 240;

    dgvTotales.Columns[2].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleLeft;
    dgvTotales.Columns[2].ReadOnly = true;
    dgvTotales.Columns[2].Width = 30;
    dgvTotales.Columns[2].Visible = false;
    ...
    dgvDetalles.Columns[4].DefaultCellStyle.Format = "$ ###,##0.00";
    ...
    dgvDetalles.Columns[7].DefaultCellStyle.Alignment = DataGridViewContentAlignment.TopCenter;
    dgvDetalles.Columns[7].ReadOnly = true;
    dgvDetalles.Columns[7].Width = 50;
    dgvDetalles.Columns[7].DefaultCellStyle.Format = "###,##0";
