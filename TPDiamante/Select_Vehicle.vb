...
Public Class Select_Vehicle
    ...
    Private Sub Select_Vehicle_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Try
            ...
            ConsutaLista = "select Placas, Marca + ' - ' + Modelo + ' - ' + cast(Año as varchar) + ' - ' + Placas as 'Nombre' from Coches t0 inner join Usuarios t1 on t0.Agente = t1.CodAgte where t0.Status = 'Activo' and t1.Id_Usuario = '" & UsrTPM & "'"
