...
Public Class Comisiones
 ...
 Sub cargar_registros()
  ...
  SQLTPD &= "INNER JOIN SBO_TPD.dbo.OINV T7 ON T7.DocNum = T6.antfac "
  SQLTPD &= "LEFT JOIN SBO_TPD.dbo.INV1 T3 ON T3.DocEntry = T7.DocEntry "
  SQLTPD &= "LEFT JOIN SBO_TPD.dbo.OSLP T4 ON T4.SlpCode = T7.SlpCode "
  SQLTPD &= "LEFT JOIN SBO_TPD.dbo.OITM T5 ON T5.ItemCode = T3.ItemCode "
