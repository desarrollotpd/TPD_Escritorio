...
Public Class Consultar_visitasporasesor
 ...
 Private subject As String = "Visitas realizadas"
 ...
 Private Function GetMailAgente() As String
        ...
        ElseIf (cmbAgente.Text = "JAVIER RIOS") Then
            Return "ventas2.merida@tractopartesdiamante.com.mx"
        ...
        ElseIf (cmbAgente.Text = "RAFAEL AVEO") Then
            Return "asesortuxtla@tractopartesdiamante.com.mx"
        ElseIf (cmbAgente.Text = "RAFAEL URVAN") Then
            Return "asesortuxtla@tractopartesdiamante.com.mx"
 ...
 Private Function EnvioMail(rutaArchivo As String, Too As String, CC As String, Subject As String, body As String, Optional CopiaOculta As String = "", Optional CopiaAgenteT As String = "") As Boolean
  Try
   ...
   smtp.Credentials = New NetworkCredential("programador.ti@tractopartesdiamante.com.mx", "N/ga_1m@_2052k43xS")
