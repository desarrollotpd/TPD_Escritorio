...
Public Class Login
 ...
 Private Sub ModuloViejoPermisos()
  ...
  If TxtUsuario.Text = "MANAGER" Or TxtUsuario.Text = "TESORERIA" Or TxtUsuario.Text = "PRUEBAS" _
      ...
      Or TxtUsuario.Text = "VENTAS8" Or TxtUsuario.Text = "VENTAS16" Or TxtUsuario.Text = "VENTAS9" Or TxtUsuario.Text = "RLIRA" _
      Or TxtUsuario.Text = "COBRANZ4" Or TxtUsuario.Text = "ALMER" _
      Or TxtUsuario.Text = "COBRANZ5" Or TxtUsuario.Text = "COBRANZ1" Or TxtUsuario.Text = "VENTAS16" _
  ...
  If TxtUsuario.Text = "MANAGER" Or TxtUsuario.Text = "SISTEMAS" Or TxtUsuario.Text = "PCOMPRAS" Or TxtUsuario.Text = "CINTER" Or TxtUsuario.Text = "COMPRAS1" Or TxtUsuario.Text = "AINVEN" Or TxtUsuario.Text = "OPALMACEN" Or TxtUsuario.Text = "OPERACIOND" Or TxtUsuario.Text = "TESORERIA" Then
   Inicio.CódigoDeBarrasToolStripMenuItem.Visible = True

   Inicio.AdministrarCódigosDeBarraToolStripMenuItem.Visible = False
   Inicio.BarCodeToolStripMenuItem.Visible = False
   Inicio.ImpresiónDeUbicacionesToolStripMenuItem.Visible = False
   Inicio.EtiquetasParaCajasDeCamiónToolStripMenuItem.Visible = False

   If TxtUsuario.Text = "MANAGER" Or TxtUsuario.Text = "SISTEMAS" Or TxtUsuario.Text = "PCOMPRAS" Or TxtUsuario.Text = "CINTER" Or TxtUsuario.Text = "COMPRAS1" Or TxtUsuario.Text = "AINVEN" Or TxtUsuario.Text = "OPERACIOND" Or TxtUsuario.Text = "TESORERIA" Then
    Inicio.AdministrarCódigosDeBarraToolStripMenuItem.Visible = True
    Inicio.BarCodeToolStripMenuItem.Visible = True
    Inicio.ImpresiónDeUbicacionesToolStripMenuItem.Visible = True
   End If
  ...
  End If
      ...
      Or TxtUsuario.Text = "MMAZZOCO" Or TxtUsuario.Text = "OPERACIOND" Or TxtUsuario.Text = "OPALMACEN" Or TxtUsuario.Text = "ALMACENE" Or TxtUsuario.Text = "PCOMPRAS" Or TxtUsuario.Text = "CINTER" Or TxtUsuario.Text = "RHUMANOS" _
      Or TxtUsuario.Text = "AMERIDA" Or TxtUsuario.Text = "ALMER" Or TxtUsuario.Text = "VVERGARA" Or TxtUsuario.Text = "VOTNIEL" Then
   Inicio.SurtimientoToolStripMenuItem.Visible = True
   Inicio.SurtimientoToolStripMenuItem.Enabled = True
  ...
  End If
      ...
      Or TxtUsuario.Text = "MMAZZOCO" Or TxtUsuario.Text = "OPERACIOND" Or TxtUsuario.Text = "OPALMACEN" Or TxtUsuario.Text = "LMARTINEZ" Or TxtUsuario.Text = "PCOMPRAS" Or TxtUsuario.Text = "CINTER" Or TxtUsuario.Text = "AINVEN" _
      Or TxtUsuario.Text = "AMERIDA" Or TxtUsuario.Text = "ALMER" Or TxtUsuario.Text = "VVERGARA" Or TxtUsuario.Text = "VOTNIEL" Then
  ...
  If TxtUsuario.Text = "MANAGER" Or TxtUsuario.Text = "TESORERIA" Or TxtUsuario.Text = "ALMACEN1" _
                                       Or TxtUsuario.Text = "OPALMACEN" Or TxtUsuario.Text = "MMAZZOCO" _
                                       Or TxtUsuario.Text = "OPERACIOND" Or TxtUsuario.Text = "AINVEN" _
                                       Or TxtUsuario.Text = "ALMER" Or TxtUsuario.Text = "ATUXTLA" Or TxtUsuario.Text = "VOTNIEL" Then
   Inicio.LiberacionDeEntregaToolStripMenuItem.Visible = True
   Inicio.LiberacionDeEntregaToolStripMenuItem.Enabled = True
  End If

  'Liberacion de Guias
  If TxtUsuario.Text = "MANAGER" Or TxtUsuario.Text = "TESORERIA" Or TxtUsuario.Text = "LMARTINEZ" Or TxtUsuario.Text = "OPALMACEN" Or TxtUsuario.Text = "AINVEN" Or TxtUsuario.Text = "COMPRAS1" _
   Or TxtUsuario.Text = "ALMER" Or TxtUsuario.Text = "ATUXTLA" Or TxtUsuario.Text = "VOTNIEL" Then
  ...
  If TxtUsuario.Text = "MANAGER" Or TxtUsuario.Text = "PCOMPRAS" Then
   Inicio.AdministrarUbicacionesSurtidoToolStripMenuItem.Enabled = True
   Inicio.AdministrarUbicacionesSurtidoToolStripMenuItem.Visible = True
  Else
   Inicio.AdministrarUbicacionesSurtidoToolStripMenuItem.Enabled = False
   Inicio.AdministrarUbicacionesSurtidoToolStripMenuItem.Visible = False
  ...
  If TxtUsuario.Text = "MANAGER" Or TxtUsuario.Text = "LMARTINEZ" _
   ...
   Or TxtUsuario.Text = "VENTAS8" Or TxtUsuario.Text = "ASTRIDY" Or TxtUsuario.Text = "VENTAS16" Or TxtUsuario.Text = "VENTAS17" Then
   Inicio.AdministraciónDePesosToolStripMenuItem.Enabled = True
   Inicio.AdministraciónDePesosToolStripMenuItem.Visible = True
  Else
   Inicio.AdministraciónDePesosToolStripMenuItem.Enabled = False
   Inicio.AdministraciónDePesosToolStripMenuItem.Visible = False
  End If
  ...
  'Al parecer este reporte fue sustituido y ya no se usa
  ''o	Estatus Ord. Venta
  ...
  End If
        ...
        If TxtUsuario.Text = "MANAGER" Or TxtUsuario.Text = "TESORERIA" Or TxtUsuario.Text = "PRUEBAS" _
      Or TxtUsuario.Text = "COMPRAS1" Or TxtUsuario.Text = "ACOMPRAS" _
      Or TxtUsuario.Text = "MMAZZOCO" Or TxtUsuario.Text = "OPERACIOND" Or TxtUsuario.Text = "OPALMACEN" Or TxtUsuario.Text = "LMARTINEZ" Or TxtUsuario.Text = "ARAMOS" _
      Or TxtUsuario.Text = "VOTNIEL" Or TxtUsuario.Text = "MCHABLE" Or TxtUsuario.Text = "ALMER" Or TxtUsuario.Text = "AINVEN" Or TxtUsuario.Text = "PCOMPRAS" Or TxtUsuario.Text = "CINTER" Then
        ...
        If TxtUsuario.Text = "MANAGER" Or TxtUsuario.Text = "TESORERIA" Or TxtUsuario.Text = "PRUEBAS" _
      Or TxtUsuario.Text = "COMPRAS1" Or TxtUsuario.Text = "ACOMPRAS" Or TxtUsuario.Text = "MMAZZOCO" Or TxtUsuario.Text = "OPERACIOND" Or TxtUsuario.Text = "OPALMACEN" Or TxtUsuario.Text = "AINVEN" Or TxtUsuario.Text = "PCOMPRAS" Or TxtUsuario.Text = "CINTER" Then
        ...
        If TxtUsuario.Text = "MANAGER" Or TxtUsuario.Text = "TESORERIA" Or TxtUsuario.Text = "PRUEBAS" _
      Or TxtUsuario.Text = "COMPRAS1" Or TxtUsuario.Text = "ACOMPRAS" Or TxtUsuario.Text = "CINTER" Then
  ...
  End If
        ...
        If TxtUsuario.Text = "MANAGER" Or TxtUsuario.Text = "TESORERIA" Or TxtUsuario.Text = "PRUEBAS" _
            Or TxtUsuario.Text = "COMPRAS1" Or TxtUsuario.Text = "ACOMPRAS" Or TxtUsuario.Text = "MMAZZOCO" Or TxtUsuario.Text = "CINTER" Or TxtUsuario.Text = "CINTER" Or TxtUsuario.Text = "OPERACIOND" Or TxtUsuario.Text = "OPALMACEN" Or TxtUsuario.Text = "PCOMPRAS" Or TxtUsuario.Text = "CINTER" Then
  ...
  End If
        ...
        'o	Categorias
        If TxtUsuario.Text = "MANAGER" Or TxtUsuario.Text = "TESORERIA" Or TxtUsuario.Text = "PRUEBAS" _
            Or TxtUsuario.Text = "COMPRAS1" Or TxtUsuario.Text = "ACOMPRAS" Or TxtUsuario.Text = "MMAZZOCO" Or TxtUsuario.Text = "OPERACIOND" Or TxtUsuario.Text = "OPALMACEN" Then
  ...
  End If
        ...
        If TxtUsuario.Text = "MANAGER" Or TxtUsuario.Text = "TESORERIA" Or TxtUsuario.Text = "PRUEBAS" Or TxtUsuario.Text = "COMPRAS1" _
                Or TxtUsuario.Text = "AINVEN" Or TxtUsuario.Text = "ACOMPRAS" Or TxtUsuario.Text = "CINTER" Or TxtUsuario.Text = "MMAZZOCO" Or TxtUsuario.Text = "OPERACIOND" Or TxtUsuario.Text = "OPALMACEN" Then
  ...
  End If
      ...
      Or TxtUsuario.Text = "MCHABLE" Or TxtUsuario.Text = "ALMER" Or TxtUsuario.Text = "VOTNIEL" Or TxtUsuario.Text = "PCOMPRAS" Or TxtUsuario.Text = "OPERACIOND" Or TxtUsuario.Text = "OPALMACEN" Then
      ...
      Or TxtUsuario.Text = "COMPRAS1" _
      Or TxtUsuario.Text = "ACOMPRAS" Or TxtUsuario.Text = "AINVEN" _
      Or TxtUsuario.Text = "VVERGARA" Or TxtUsuario.Text = "RROBLES" Or TxtUsuario.Text = "AMERIDA" _
      Or TxtUsuario.Text = "MCHABLE" Or TxtUsuario.Text = "ALMER" Or TxtUsuario.Text = "VOTNIEL" Or TxtUsuario.Text = "PCOMPRAS" Or TxtUsuario.Text = "CINTER" Or TxtUsuario.Text = "OPERACIOND" Or TxtUsuario.Text = "OPALMACEN" Then
        ...
        'o Facturas
        If TxtUsuario.Text = "MANAGER" Or TxtUsuario.Text = "TESORERIA" Or TxtUsuario.Text = "PRUEBAS" _
      Or TxtUsuario.Text = "MMAZZOCO" Or TxtUsuario.Text = "OPERACIOND" Or TxtUsuario.Text = "OPALMACEN" Or TxtUsuario.Text = "COMPRAS1" _
      Or TxtUsuario.Text = "ACOMPRAS" _
      Or TxtUsuario.Text = "VVERGARA" Or TxtUsuario.Text = "RROBLES" Or TxtUsuario.Text = "AMERIDA" _
      Or TxtUsuario.Text = "MCHABLE" Or TxtUsuario.Text = "ALMER" Or TxtUsuario.Text = "VOTNIEL" Then
      ...
      Or TxtUsuario.Text = "ACOMPRAS" _
      Or TxtUsuario.Text = "VVERGARA" Or TxtUsuario.Text = "RROBLES" Or TxtUsuario.Text = "AMERIDA" _
      Or TxtUsuario.Text = "MCHABLE" Or TxtUsuario.Text = "ALMER" Or TxtUsuario.Text = "VOTNIEL" Or TxtUsuario.Text = "PCOMPRAS" Then
      ...
      Or TxtUsuario.Text = "MCHABLE" Or TxtUsuario.Text = "ALMER" Or TxtUsuario.Text = "VOTNIEL" Or TxtUsuario.Text = "PCOMPRAS" Then
        ...
        If TxtUsuario.Text = "MANAGER" Or TxtUsuario.Text = "TESORERIA" Or TxtUsuario.Text = "PRUEBAS" Or TxtUsuario.Text = "COMPRAS1" Or TxtUsuario.Text = "PCOMPRAS" Or TxtUsuario.Text = "CINTER" Or TxtUsuario.Text = "OPERACIOND" Or TxtUsuario.Text = "OPALMACEN" Then
        ...
        If TxtUsuario.Text = "MANAGER" Or TxtUsuario.Text = "TESORERIA" Or TxtUsuario.Text = "PRUEBAS" Or TxtUsuario.Text = "OPERACIOND" Or TxtUsuario.Text = "OPALMACEN" Then
        ...
        If TxtUsuario.Text = "MANAGER" Or TxtUsuario.Text = "TESORERIA" Or TxtUsuario.Text = "PRUEBAS" Or TxtUsuario.Text = "MMAZZOCO" Or TxtUsuario.Text = "OPERACIOND" Or TxtUsuario.Text = "OPALMACEN" Or TxtUsuario.Text = "COMPRAS1" Then
        ...
        If TxtUsuario.Text = "MANAGER" Or TxtUsuario.Text = "TESORERIA" Or TxtUsuario.Text = "PRUEBAS" Or TxtUsuario.Text = "AINVEN" Or TxtUsuario.Text = "COMPRAS1" Or TxtUsuario.Text = "PCOMPRAS" Or TxtUsuario.Text = "CINTER" Or TxtUsuario.Text = "OPERACIOND" Or TxtUsuario.Text = "OPALMACEN" Then
            Inicio.SMFacturaArticulos.Visible = True
            Inicio.SMFacturaArticulos.Enabled = True
        End If

        If TxtUsuario.Text = "MANAGER" Or TxtUsuario.Text = "COBRANZ2" Or TxtUsuario.Text = "OPERACIOND" Or TxtUsuario.Text = "OPALMACEN" Or TxtUsuario.Text = "ALMER" Or TxtUsuario.Text = "VOTNIEL" _
            Or TxtUsuario.Text = "VENTAS2" Or TxtUsuario.Text = "VENTAS3" Or TxtUsuario.Text = "RLIRA" Or TxtUsuario.Text = "VENTAS14" Or TxtUsuario.Text = "VENTAS8" Or TxtUsuario.Text = "VENTAS16" _
  ...
  'PAGOS RECIBIDOS
  Inicio.PagosRecibidosToolStripMenuItem.Visible = False
  If TxtUsuario.Text = "MANAGER" Or TxtUsuario.Text = "ACTAS" Or TxtUsuario.Text = "COBRANZ2" Or TxtUsuario.Text = "CONTAB1" Then
   Inicio.PagosRecibidosToolStripMenuItem.Visible = True
   Inicio.PagosRecibidosToolStripMenuItem.Visible = True
  End If
  ...
  End If
        ...
        Or TxtUsuario.Text = "VENTAS6" Or TxtUsuario.Text = "VENTAS8" Or TxtUsuario.Text = "VENTAS16" _
        ...
        Or TxtUsuario.Text = "VMERIDA" Or TxtUsuario.Text = "OPERACIOND" Or TxtUsuario.Text = "OPALMACEN" Then
  ...
  End If
        ...
        'PACKING'
        If TxtUsuario.Text = "MANAGER1111" Or TxtUsuario.Text = "OPERACIOND" Or TxtUsuario.Text = "OPALMACEN" Then
            'Inicio.FacturasCanceladas.Visible = True
            Inicio.PackinToolStripMenuItem.Enabled = True
            Inicio.PackinToolStripMenuItem.Visible = True
        End If
