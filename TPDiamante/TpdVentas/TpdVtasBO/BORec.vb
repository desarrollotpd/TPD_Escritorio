...
Public Class BORec
	...
	Private Sub BackOrder_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
		...
		Using SqlConnection As New Data.SqlClient.SqlConnection(StrCon)
			...
			If UsrTPM = "ACASTRO" Or UsrTPM = "JSANCHEZ" Or UsrTPM = "RMERCADO" Or UsrTPM = "ABAJIO" Or UsrTPM = "ATUXTLA" _
												...
												Or UsrTPM = "VENTAS4" Or UsrTPM = "RJIMENEZ" Or UsrTPM = "LCEBALLOS" Or UsrTPM = "ATABASCO" Then
				'MsgBox(UsrTPM)
				'MsgBox(vCodAgte)
			...
			ElseIf UsrTPM = "VENTAS8" Then
				ConsutaLista = "SELECT CardCode,CardName, SlpCode, GroupCode FROM OCRD WHERE CardType = 'C' AND SlpCode IN (57,8) ORDER BY CardName "
			ElseIf UsrTPM = "VENTAS16" Then
				ConsutaLista = "SELECT CardCode,CardName, SlpCode, GroupCode FROM OCRD WHERE CardType = 'C' AND SlpCode IN (52) ORDER BY CardName "
	...
	Private Sub mllenaComboAlmacen(ByVal conexion As SqlConnection)
		Try
			...
			If UsrTPM = "MANAGER" Or UsrTPM = "PRUEBAS" Or UsrTPM = "DDORANTES" Or UsrTPM = "COMERCIAL" Or UsrTPM = "CGARCIA" Then
	...
	Private Sub mllenaComboVtaAgente()
		Try
			Using SqlConnection As New Data.SqlClient.SqlConnection(StrTpm)
				...
				If UsrTPM = "MANAGER" Or UsrTPM = "AINVEN" Or UsrTPM = "PRUEBAS" Or UsrTPM = "DDORANTES" Or UsrTPM = "COMERCIAL" Or UsrTPM = "CGARCIA" Then
					ds.Tables(0).Rows.Add(0, "TODOS")
				End If
