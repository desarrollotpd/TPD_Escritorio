...
Public Class frmBonoMensual
 ...
 Private Sub CargaAgente(Renglon As Integer)
  If Renglon >= 0 Then
   ...
   txtPorcentajeMinimoParaBono.Text = Trim(rowInfPA.Cells("MinimoParaBono").Value).ToString() & "%"
   txtPorcCorrGeneral.Text = Trim(rowInfPA.Cells("Porc_ScoreCard").Value).ToString() & "%"
   txtPorcCorrHalcon.Text = Trim(rowInfPA.Cells("Porc_Halcon").Value).ToString() & "%"
   txtPorcCorrLineas.Text = Trim(rowInfPA.Cells("Porc_LineasObjetivo").Value).ToString() & "%"
   txtPorcCorrClientes.Text = Trim(rowInfPA.Cells("Porc_Clientes").Value).ToString() & "%"
