...
Public Class frmcancelacion_nc
 ...
 Sub llena_grid_autoriza()
  ...
  Try
   ...
   SQLautoriza &= "FROM Documents_Cancel WHERE status = 'EN PROCESO DE CANCELACION' AND id_warehouse = '" + almacen + "'"
 ...
 Sub EnviaProcesoCancelacion()
  ...
  Try 'CAPTURA EL ERROR
   ...
   If conexion_universal.rd_s.Read Then
    ...
    'cc = "" 'Esto solo lo pongo para pruebas
  ...
  Try 'CAPTURA EL ERROR
   ...
   If conexion_universal.rd_s.Read Then
    ...
    'para = "licjorgeluis@hotmail.com"  'Esto solo lo pongo para pruebas
   End If
   'ALMACENA BANDERA PARA EL ENVIO SI TIENE EMISOR
   envio_ok = True
   'CIERRA LA CONEXION
  ...
  Try 'CAPTURA ERROR DE ENVIO DE CORREO
   ...
   If cmbstatus.SelectedIndex <> -1 And envio_de_ok = True Then
    ...
    Try 'CAPTURA EL ERROR
     ...
     While conexion_universal.rd_s.Read
      ...
      If conexion_universal.rd_s.Item("fase_nombre") = "P" Then
       ...
       If (conexion_universal.rd_s.Item("correo") = para) Then
      ...
      'Esto de abajo solo lo pongo para pruebas
      'Msg.CC.Clear() 'Esto solo lo pongo para pruebas
      'Msg.Bcc.Clear() 'Esto solo lo pongo para pruebas
     End While
    ...
    ElseIf (DocDate >= fechaMigracionCFDI_40) Then  'Formato migracion CFDI 4.0
     DocFacturas.Load("\\" & conexion_universal.RutaReportes & "\b1_shr\xml\TPD\NC_Abr2023_4.0.rpt") ' //RUTA DEL ARCHIVO .rpt
    Else
    ...
    Try
     '//ALMACENA EL PDF EN LA RUTA TEMPORAL ...\TPDiamante\bin\Debug
    ...
    ElseIf (DocDate > fechaMigracionCFDI_40) Then  'Formato post migracion CFDI 4.0
    ...
    Titulo = "(F3) Cancelación de Factura [ " + txtfactura.Text + " ]"
