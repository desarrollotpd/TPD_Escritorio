...
#Region "Eventos KeyDown TXT"
 ...
 Private Sub DetalleEmpaquePeso_Activated(sender As Object, e As EventArgs) Handles Me.Activated
  'Valido que no haya algun bloqueo por pedido diario
  If BloqueEnEmpaque(DocNumSurtido, DocNumEmpacar) = True Then
   MsgBox("Este pedido esta esperando almenos un artículo de pedido diario que ya debió haber sido confirmado por lo que no podrá ser cerrado hasta que este llegue", MsgBoxStyle.Information, "En espera de artículo")
   Exit Sub
  End If
 End Sub
#End Region
