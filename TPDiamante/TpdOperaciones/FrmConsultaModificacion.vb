...
Public Class FrmConsultaModificacion
 ...
 Sub MBuscarOrdenes()
    ...
    Sub LlenarConsulta()
        Try
   dgvConsulta.DataSource = SQL.EjecutarProcedimiento("TPD_ConMod_Surtir", "@FechaInicial,@FechaFin,@CveSucursal", 3, dtpFecha.Value.ToString("yyyy-MM-dd") & "," & DTPFechaFin.Value.ToString("yyyy-MM-dd") & "," & AlmTPM)
   EstiloDgvConsulta()
