...
Public Class frmpantallasEntrega
 ...
 Sub MLlenaOrdenesSurtir()
  Try
   ...
   Dim cmd = New SqlCommand("TPD_Surtir_Almacen", conec)
   ...
   Dim dvInf As New DataView
   dvInf.Table = DsOrderVentas.Tables(0)
   dgvSurtir.DataSource = dvInf
