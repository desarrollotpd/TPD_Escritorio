...
Public Class frmAcceso
 ...
 Private Sub btnAceptar_Click(sender As Object, e As EventArgs) Handles btnAceptar.Click
  ...
  'El de arriba se puede cambiar por este de abajo o el que esta abajo de este
  SQLAnalisis = "SELECT T0.DocEntry, T0.DocNum, FORMAT(T0.DocDate, 'yyyy-MM-dd') AS DocDate, FORMAT(T0.PrintTime, 'yyyy-MM-dd HH:mm:ss') AS PrintTime, FORMAT(GETDATE(), 'yyyy-MM-dd HH:mm:ss') AS DocDateO, T0.Status, T0.UserId_Surtido, "
  'SQLAnalisis = "SELECT T0.DocEntry, T0.DocNum, T0.DocDate, T0.PrintTime, GETDATE() DocDateO, T0.Status, T0.UserId_Surtido, "
  ...
  Try
   ...
   SQLAnalisis &= "'" + SDocEntry + "', '" + SDocNum + "',  '" + funciones.ConvertFechaNormalToSQL(SDocDate) + "', '" + SPrintTime + "', '" + SDocDateO + "', '" + SStatus + "', '" + SUserId_Surtido + "', '" + SCardCode + "', '" + SCardName + "' )"
