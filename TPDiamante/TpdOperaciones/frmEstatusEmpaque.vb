...
#Region "Metodos"
    ...
    Sub LlenarEmpaque()
        ...
        tbBandera = SQL.EjecutarProcedimiento("TPD_Estatus_Empaque", "@CveSucursal", 1, CveSucursal)
        If tbBandera.Rows.Count <> 0 Then
            dgvEmpaque.DataSource = SQL.EjecutarProcedimiento("TPD_Estatus_Empaque", "@CveSucursal", 1, CveSucursal)
