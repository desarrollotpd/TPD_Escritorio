...
Public Class frmAdminBarCode
	...
	Private Sub ObtenerArticuloAlterno()
		...
		Try
			...
			'Validar que el codigo de barras alterno a registgrar no exista ni en la tabla de alternos ni como codigo de proveedor
			Articulo = ValidoExistenciaCB(TextBox4.Text)
			If Articulo = "" Then
				...
				con.Close()
			Else
				MsgBox("El código de barra ya está registado para el artículo: " & Articulo, MsgBoxStyle.Exclamation, "Este CB ya esta registrado")
			End If
	...
	Private Function ValidoExistenciaCB(NuevoCBAlterno As String) As String
		Try
			Dim Cons As Integer = -1
			Dim sCons As String
			Dim strSelect As String
			...
			strSelect = "SELECT articulo FROM Barcode_alterno WHERE BARCODE_ALTERNO = '" & NuevoCBAlterno & "' UNION SELECT articulo FROM Barcode WHERE BARCODE_PZE = '" & NuevoCBAlterno & "'"
