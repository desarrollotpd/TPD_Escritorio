...
Public Class frmAdminBarCode
    ...
    Private Sub EliminarArticuloAlterno()
        ...
        Try
            ...
            CadenaSQL1 = "delete from Barcode_alterno where articulo='" & txtArt_CodAlterno.Text & "' and barcode_alterno = '" & cmbCodigoAlterno.Text & "'"
            con.ConnectionString = SQL.StrTpm
            con.Open()
            cmd.Connection = con
            cmd.CommandText = CadenaSQL1
            cmd.ExecuteNonQuery()
            con.Close()
        Catch ex As Exception
            MessageBox.Show("El Código está asignado a otro artículo")
    ...
    Private Sub Button6_Click(sender As Object, e As EventArgs) Handles Button6.Click
        EliminarArticuloAlterno()
        Consultar_CodAlt()
        MsgBox("El codigo sea elimninado correctamente...")
    End Sub
End Class