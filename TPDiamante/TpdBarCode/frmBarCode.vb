...
Public Class frmBarCode
 ...
 Sub zplPrint(BarCode As String, Articulo As String, Descripcion As String, Clasificacion As String, Copias As Integer)
  'Usa programacion Programación ZPL
  'https://supportcommunity.zebra.com/s/article/ZPL-Command-Information-and-DetailsV2?language=es
  ...
  If Copias <> 0 Then
   For i = 1 To Copias
    ...
    'Se agregar codigo QR
    ZPLCommand &= "^FO585,50^A0N,17,17^BY2,1.0,15^BQN,2,3,H,N,A^FH^FDMM,F" + BarCode.Replace("&", ",B00" & BarCode.Length & "_26") + "^FS"
