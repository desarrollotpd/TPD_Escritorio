...
Public Class CargaCombustible
            ...
            If TextBox4.Text <> "" Then
                Try
                    ...
                    If od > 500000 Then
                        ...
                        MessageBox.Show("El odometro no deberia ser mayor a 500,000 Km", "Error", MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
    ...
    Public Sub verifica_odometro()
        If TextBox4.Text <> "" Then
            Try
                If CDec(TextBox4.Text) > 500000 Then
                    MessageBox.Show("El odometro no deberia ser mayor a 500,000 Km", "Error", MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
                End If
            Catch ex As Exception
                MessageBox.Show("Ingresa un odometro valido", "Error", MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
        ...
        If TextBox4.Text <> "" Then
            Try
                ...
                If odometro_nuevo <> 0 Then
                    If odometro_nuevo < 500000 And odometro_nuevo > odometro_anterior Then
                        Verifica_Campos = True
                    Else
                        If odometro_nuevo > 500000 Then
                            MessageBox.Show("Verifica que el odometro nuevo no sea mayor a 500,000 Km", "Error", MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
