...
Public Class BackOrderVtas
  ...
  ElseIf UsrTPM = "ACASTRO" Or UsrTPM = "JSANCHEZ" Or UsrTPM = "RMERCADO" Or UsrTPM = "AVERACRUZ" Or UsrTPM = "ABAJIO" _
  ...
  Dim FchInicio As DateTime
   ...
   If UsrTPM = "ACASTRO" Or UsrTPM = "JSANCHEZ" Or UsrTPM = "RMERCADO" Or UsrTPM = "ABAJIO" Or UsrTPM = "AVERACRUZ" _
            Or UsrTPM = "VENTAS4" Or UsrTPM = "RJIMENEZ" Or UsrTPM = "ATUXTLA" Or UsrTPM = "VENTAS5" Or UsrTPM = "VENTAS9" Or UsrTPM = "LCEBALLOS" Or UsrTPM = "ATABASCO" Then
    'MsgBox(UsrTPM)
    'MsgBox(vCodAgte)
    Me.CmbAgteVta.SelectedValue = vCodAgte
    Me.CmbAgteVta.Enabled = False
